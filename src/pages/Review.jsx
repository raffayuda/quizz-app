  ...
  return (
    <div className="h-full relative p-[54px] flex flex-col gap-[54px]">
      ...
      <div className="w-full flex justify-center">
        <div className="h-[161px] w-[500px] rounded-[20px] flex text-white p-5 bg-amber-800 border-solid border-white border-[6px]">
          {answer[index + 1]
            ? `${answer[index + 1]}. ${
      ...
      <div className="flex items-center justify-center gap-2 text-white text-[32px]">
      ...
      <div className="text-center text-amber-800 text-[20px]">
      ...
      <div className="absolute bottom-[20px] right-[54px] flex justify-end mx-[20px] gap-5">
        ...
        <div
          ...
          className="text-[36px] bg-amber-700 flex items-center p-1 text-pink-400 border-[6px] border-pink-400 hover:scale-110 hover:text-white hover:border-white"
        >
          View Score
        </div>
      </div>
